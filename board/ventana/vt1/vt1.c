...
static const char *itrace_params_qemu[RV_ETRACE_PARAM_MAX_LEN] = {
	...
	".packet.tstamp_bytes_p,1",
	".packet.type_width_p,0",

	".itrace.arch_p,0",
	".itrace.blocks_p,0",
	".itrace.bpred_size_p,5",
	".itrace.cache_size_p,4",
	".itrace.call_counter_size_p,0",

	".itrace.time_width_p,29",
	".itrace.context_width_p,22",
	".itrace.ecause_width_p,6",
	".itrace.f0s_width_p,1",
	".itrace.iaddress_lsb_p,1",
	".itrace.iaddress_width_p,50",

	".itrace.nocontext_p,0",
	".itrace.notime_p,0",
	".itrace.privilege_width_p,3",
	".itrace.return_stack_size_p,4",
	".itrace.sijump_p,0",

	".itrace.comparators_p,0",
	".itrace.filters_p,0",
	".itrace.ecause_choice_p,0",
	...
	".itrace.ctype_width_p,1",
	".itrace.ilastsize_width_p,1 ",
	".itrace.itype_width_p,4",
	".itrace.iretire_width_p,6",
	".itrace.retires_p,6",
